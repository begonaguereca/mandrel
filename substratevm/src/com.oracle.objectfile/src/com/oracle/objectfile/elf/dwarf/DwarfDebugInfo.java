...
public class DwarfDebugInfo extends DebugInfoBase {
    ...
    public static final int DW_ABBREV_CODE_method_location_w_childer = 32;
    public static final int DW_ABBREV_CODE_method_location_inline = 33;
    public static final int DW_ABBREV_CODE_method_location_inline_w_chidren = 34;
